...
class AccountController extends Controller
{
    ...
    public function updateProfileImage(Request $request)
    {
        ...
        if ($validator->passes()) {
            ...
            $image->cover(150, 150);
            $image->toPng()->save(public_path('/images/thumb/' . $imageName));

            // delete old profile pic
            File::delete(public_path('/images/thumb/' . Auth::user()->image));
    ...
    public function myJobApplications(){
        ...
        return view('front.account.job.myjob_application',[
    ...
    public function savedJobs(){
        ...
        return view('front.account.job.saved_jobs',[
            'savedJobs' => $savedJobs
        ]);
    }
